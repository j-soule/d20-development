...
function DeveloperCard({firstName, lastName, avatar, email, experience, active}){
    const variants = {
    ...
    return(
        <aside className='w-full m-4 sm:m-0 sm:w-[calc(50%_-_0.5rem)] lg:w-[calc(33%_-_1rem)] py-10 border-gray-200/50 rounded-md shadow-md'>
            ...
            <dl>
                ...
                <dd className={`${active? variants.active : variants.inactive}`}>{active? "not available": "available"}</dd>
